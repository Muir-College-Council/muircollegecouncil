...
const councilMembers = [
  ...
  { name: 'Vincent Lopez', role: 'VP Internal' },
  { name: 'Kaylie Hough', role: 'VP External' },
  { name: 'Trung Nguyen', role: 'VP Finance' },
  { name: 'Michael Pieniaszek', role: 'VP Administrative Affairs' },
  { name: 'Saniya Harlalka', role: 'VP Programming' },
